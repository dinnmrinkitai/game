...
public class LevelDuake3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_duake3);
        ...
        next1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View bebek) {
                Intent myIntent = new
                        Intent(bebek.getContext(), LevelDuake4.class);
    ...
    public void tampilDialog() {
        ...
        builder.setMessage("Jawaban anda benar : Jagung");
        builder.setPositiveButton("OKE", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(LevelDuake3.this, "Selamat", Toast.LENGTH_SHORT).show();
            }
        });
