...
public class LevelTigake2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_tigake2);
        ...
        next1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View bebek) {
                Intent myIntent = new
                        Intent(bebek.getContext(), LevelTigake3.class);
    ...
    public void tampilDialog() {
        ...
        builder.setMessage("Jawaban anda benar : Nemo");
        builder.setPositiveButton("OKE", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(LevelTigake2.this, "Selamat", Toast.LENGTH_SHORT).show();
            }
        });
