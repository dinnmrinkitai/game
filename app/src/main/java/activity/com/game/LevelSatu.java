...
public class LevelSatu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_satu);
        ...
        next1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View bebek) {
                Intent myIntent = new
                        Intent(bebek.getContext(), LevelSatuke1.class);
    ...
    public void tampilDialog() {
        ...
        builder.setMessage("Jawaban anda benar : Ayam");
        builder.setPositiveButton("OKE", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(LevelSatu.this, "Selamat", Toast.LENGTH_SHORT).show();
            }
        });
