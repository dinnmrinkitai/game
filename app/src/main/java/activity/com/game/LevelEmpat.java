...
public class LevelEmpat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_empat);
    ...
    public void tampilDialog() {
        ...
        builder.setMessage("Jawaban anda benar : Dylan O'brien");
        builder.setPositiveButton("OKE", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(LevelEmpat.this, "Selamat", Toast.LENGTH_SHORT).show();
            }
        });
