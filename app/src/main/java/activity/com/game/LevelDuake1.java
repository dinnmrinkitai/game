...
public class LevelDuake1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_duake1);
        ...
        next1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View bebek) {
                Intent myIntent = new
                        Intent(bebek.getContext(), LevelDuake2.class);
    ...
    public void tampilDialog() {
        ...
        builder.setMessage("Jawaban anda benar : Cemara");
        builder.setPositiveButton("OKE", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(LevelDuake1.this, "Selamat", Toast.LENGTH_SHORT).show();
            }
        });
