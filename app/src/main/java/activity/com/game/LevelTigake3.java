...
public class LevelTigake3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_tigake3);
        ...
        next1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View bebek) {
                Intent myIntent = new
                        Intent(bebek.getContext(), LevelTigake4.class);
    ...
    public void tampilDialog() {
        ...
        builder.setMessage("Jawaban anda benar : Minion");
        builder.setPositiveButton("OKE", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(LevelTigake3.this, "Selamat", Toast.LENGTH_SHORT).show();
            }
        });
