...
public class LevelTigake1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_tigake1);
        ...
        next1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View bebek) {
                Intent myIntent = new
                        Intent(bebek.getContext(), LevelTigake2.class);
    ...
    public void tampilDialog() {
        ...
        builder.setMessage("Jawaban anda benar : Toy Story");
        builder.setPositiveButton("OKE", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(LevelTigake1.this, "Selamat", Toast.LENGTH_SHORT).show();
            }
        });
