...
public class LevelSatuke2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_satuke2);
        ...
        next1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View bebek) {
                Intent myIntent = new
                        Intent(bebek.getContext(), LevelSatuke3.class);
    ...
    public void tampilDialog() {
        ...
        builder.setMessage("Jawaban anda benar : Tikus");
        builder.setPositiveButton("OKE", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(LevelSatuke2.this, "Selamat", Toast.LENGTH_SHORT).show();
            }
        });
