...
public class LevelSatuke3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_satuke3);
        ...
        next1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View bebek) {
                Intent myIntent = new
                        Intent(bebek.getContext(), LevelSatuke4.class);
    ...
    public void tampilDialog() {
        ...
        builder.setMessage("Jawaban anda benar : Kakak Tua");
        builder.setPositiveButton("OKE", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(LevelSatuke3.this, "Selamat", Toast.LENGTH_SHORT).show();
            }
        });
