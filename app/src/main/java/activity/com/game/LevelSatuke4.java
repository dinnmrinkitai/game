...
public class LevelSatuke4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_satuke4);
    ...
    public void tampilDialog() {
        ...
        builder.setMessage("Jawaban anda benar : Singa");
        builder.setPositiveButton("OKE", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(LevelSatuke4.this, "Selamat", Toast.LENGTH_SHORT).show();
            }
        });
